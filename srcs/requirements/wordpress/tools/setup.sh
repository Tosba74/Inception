...
if  [ ! -f /var/www/html/wordpress/wp-config.php ]; then
    ...
    wp core install --allow-root --url='bmangin.42.fr' --title='Inception' --admin_user=bmangin --admin_password=bmangin42  --admin_email="bmangin@student.42lyon.fr" --path='/var/www/html/wordpress';
